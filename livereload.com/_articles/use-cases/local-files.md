...
LiveReload is cool with file: URLs, unless you're using a Safari browser extension, which does not allow that. (See: {% ref browser: How do I choose the best integration method? %})
